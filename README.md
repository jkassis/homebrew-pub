...
- jarhead: terminal frontend for native Codex and Claude agent runtimes.
...
```sh
./release-jarhead VERSION CLEAN_SOURCE_WORKTREE
```
...
JarHead passes the user's configured Claude executable to the SDK explicitly.
