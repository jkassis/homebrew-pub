  ...
  on_linux do
    ...
    if Hardware::CPU.intel? && Hardware::CPU.is_64_bit?
      url "https://github.com/jkassis/gitall/releases/download/0.8.29/gitall-linux-amd64-1.0.1.archlinux"
    ...
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/jkassis/gitall/releases/download/0.8.29/gitall-linux-arm64-1.0.1.archlinux"
