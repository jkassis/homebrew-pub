class Jarhc < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/jkassis/homebrew-pub/releases/download/jarhc-dist-v0.1.2/jarhc-darwin-arm64-0.1.2.tar.gz"
      sha256 "257107964becc656b7ba114af35a4d32e1251894e41e4794ac1f7511a1d4533d"
    end

    if Hardware::CPU.intel?
      url "https://github.com/jkassis/homebrew-pub/releases/download/jarhc-dist-v0.1.2/jarhc-darwin-amd64-0.1.2.tar.gz"
